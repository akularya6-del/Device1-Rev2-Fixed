...
def build_board():
    ...
    # NRST: U1.18 -> C11.1 on F.Cu -> route east to X=9.8, then north to TP_NRST on B.Cu via
    nrst_net = nets["NRST"]
    ...
    route_points([c11_1, (9.8, 7.98), tp_nr], pcbnew.F_Cu, nrst_net, 0.15)
    ...
    route_points([(3.0, 15.0), (0.5, 15.0), (0.5, 26.8), (7.5, 26.8)], pcbnew.B_Cu, mic_sd_net, 0.15)
    ...
    route_points([(3.0, 13.5), (0.9, 13.5), (0.9, 26.2), (6.6, 26.2)], pcbnew.B_Cu, mic_ws_net, 0.15)
    ...
    add_via(9.2, 8.8, mic_sck_net)
    add_track(u1_17[0], u1_17[1], 9.2, 8.8, pcbnew.F_Cu, mic_sck_net, 0.15)
    add_via(9.2, 27.958, mic_sck_net)
    add_track(9.2, 27.958, mk1_4[0], mk1_4[1], pcbnew.F_Cu, mic_sck_net, 0.15)
    add_track(9.2, 8.8, 9.2, 27.958, pcbnew.B_Cu, mic_sck_net, 0.15)
    ...
    # BATT_NEG: U4.6 (4.138, 23.25) -> Q1.4 (8.637, 25.15) & TP_BATT_N (2.0, 25.0)
    batt_neg_net = nets["BATT_NEG"]
    tp_bn = get_pad_pos("TP_BATT_N", "1") # (2.0, 25.0)
    u4_6  = get_pad_pos("U4", "6")        # (4.138, 23.25)
    q1_4  = get_pad_pos("Q1", "4")        # (8.637, 25.15)
    add_via(tp_bn[0], tp_bn[1], batt_neg_net)
    route_points([tp_bn, (4.138, 25.0), (4.138, 26.2), (8.637, 26.2), q1_4], pcbnew.F_Cu, batt_neg_net, 0.25)
    add_track(u4_6[0], u4_6[1], 4.138, 25.0, pcbnew.F_Cu, batt_neg_net, 0.25)
    ...
    route_points([c10_1, (12.72, 16.5), (13.8, 16.5), (13.8, 21.15), u2_4], pcbnew.F_Cu, vbus_net, 0.25)
    # Connect U2.4 to Q2.1
    route_points([u2_4, (13.8, 22.5), (11.062, 22.5), q2_1], pcbnew.F_Cu, vbus_net, 0.20)
    # Connect D1.2 to Q2.1 via empty corridor
    route_points([d1_2, (9.5, 21.2), (9.5, 22.5), (11.062, 22.5)], pcbnew.F_Cu, vbus_net, 0.20)
    ...
    add_via(10.863, 22.0, vbat_net)
    add_track(u2_3[0], u2_3[1], 10.863, 22.0, pcbnew.F_Cu, vbat_net, 0.20)
    add_via(12.938, 23.5, vbat_net)
    add_track(12.938, 23.5, q2_3[0], q2_3[1], pcbnew.F_Cu, vbat_net, 0.20)
    route_points([(10.863, 22.0), (12.938, 22.0), (12.938, 23.5)], pcbnew.B_Cu, vbat_net, 0.20)

    # SYS_PWR: D1.1 -> Q2.2 via F.Cu; U5.3 -> B.Cu -> C9.1 & U5.1
    ...
    route_points([d1_1, (5.0, 21.20), (5.0, 26.6), (11.062, 26.6), q2_2], pcbnew.F_Cu, sys_net, 0.25)
    ...
    add_track(mk1_5[0], mk1_5[1], 8.4, 26.2, pcbnew.F_Cu, p3v3_net, 0.25)
