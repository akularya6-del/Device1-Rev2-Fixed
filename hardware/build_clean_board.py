...
def create_board():
    ...
    fp_defs = [
        ...
        ("R7", "Resistor_SMD", "R_0402_1005Metric", 10.6, 29.4, 0),
        # RF matching network
    ...
    add_via(13.2, 20.0, p3v3_net) # TP_3V3
    add_track(8.4, 27.436, 9.2, 27.436, pcbnew.F_Cu, p3v3_net, 0.20)
    add_track(9.2, 27.436, 9.2, 26.2, pcbnew.F_Cu, p3v3_net, 0.20)
    add_via(9.2, 26.2, p3v3_net)
    
    # Left power rail
    add_track(1.8, 10.48, 2.6, 10.48, pcbnew.F_Cu, p3v3_net, 0.20)
    add_via(2.6, 10.48, p3v3_net)
    add_track(1.8, 15.48, 2.6, 15.48, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_track(3.2, 9.75, 3.2, 11.75, pcbnew.F_Cu, p3v3_net, 0.20)
    add_track(3.2, 10.48, 2.6, 10.48, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_track(6.75, 15.938, 6.75, 17.8, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    print("Device1.kicad_pcb generated and saved")
