...
def build():
    ...
    # Bottom Layer Test Points (placed cleanly in open zones)
    tp_defs = [
        ("TP_SWDIO", 2.8, 22.8, "SWDIO"),
        ("TP_SWCLK", 5.5, 22.8, "SWCLK"),
        ("TP_NRST", 1.8, 22.8, "NRST"),
        ("TP_BOOT0", 2.4, 20.0, "BOOT0"),
        ("TP_VBUS", 12.2, 24.5, "VBUS_5V"),
        ("TP_BATT_P", 4.1, 26.8, "BATT_POS"),
        ("TP_BATT_N", 8.6, 26.8, "BATT_NEG"),
    ...
    # Channeled B.Cu Signal Bus (Strictly distinct X-columns!)
    # MIC_WS: X = 3.6
    add_track(6.600, 27.436, 3.6, 27.436, pcbnew.F_Cu, nets["MIC_WS"], 0.15)
    add_via(3.6, 27.436, nets["MIC_WS"])
    add_track(3.6, 27.436, 3.6, 13.250, pcbnew.B_Cu, nets["MIC_WS"], 0.15)
    add_via(3.6, 13.250, nets["MIC_WS"])
    add_track(3.6, 13.250, 4.062, 13.250, pcbnew.F_Cu, nets["MIC_WS"], 0.15)

    # MIC_SD: X = 4.4
    add_track(7.500, 27.436, 4.4, 27.436, pcbnew.F_Cu, nets["MIC_SD"], 0.15)
    add_via(4.4, 27.436, nets["MIC_SD"])
    add_track(4.4, 27.436, 4.4, 13.750, pcbnew.B_Cu, nets["MIC_SD"], 0.15)
    add_via(4.4, 13.750, nets["MIC_SD"])
    add_track(4.4, 13.750, 4.062, 13.750, pcbnew.F_Cu, nets["MIC_SD"], 0.15)

    # MIC_SCK: X = 8.4
    add_track(8.400, 28.258, 8.400, 26.5, pcbnew.F_Cu, nets["MIC_SCK"], 0.15)
    add_via(8.400, 26.5, nets["MIC_SCK"])
    add_track(8.400, 26.5, 8.400, 8.2, pcbnew.B_Cu, nets["MIC_SCK"], 0.15)
    add_via(8.400, 8.2, nets["MIC_SCK"])
    add_track(8.400, 8.2, 8.250, 9.062, pcbnew.F_Cu, nets["MIC_SCK"], 0.15)

    # SWDIO: X = 2.8
    add_track(4.062, 15.250, 2.8, 15.250, pcbnew.F_Cu, nets["SWDIO"], 0.15)
    add_via(2.8, 15.250, nets["SWDIO"])
    add_track(2.8, 15.250, 2.8, 22.8, pcbnew.B_Cu, nets["SWDIO"], 0.20)

    # SWCLK: X = 5.5
    add_track(7.250, 15.938, 5.5, 17.0, pcbnew.F_Cu, nets["SWCLK"], 0.15)
    add_via(5.5, 17.0, nets["SWCLK"])
    add_track(5.5, 17.0, 5.5, 22.8, pcbnew.B_Cu, nets["SWCLK"], 0.20)
    ...
    add_track(1.8, 5.0, 1.8, 22.8, pcbnew.B_Cu, nets["NRST"], 0.15)

    # BOOT0: X = 2.4
    add_track(7.250, 9.062, 7.250, 8.6, pcbnew.F_Cu, nets["BOOT0"], 0.15)
    add_track(7.250, 8.6, 2.4, 8.6, pcbnew.F_Cu, nets["BOOT0"], 0.15)
    add_track(2.4, 8.6, 1.8, 8.31, pcbnew.F_Cu, nets["BOOT0"], 0.15)
    add_via(2.4, 7.8, nets["BOOT0"])
    add_track(2.4, 7.8, 2.4, 20.0, pcbnew.B_Cu, nets["BOOT0"], 0.20)

    # LED_R: X = 10.5
    add_track(10.938, 9.750, 10.5, 9.750, pcbnew.F_Cu, nets["LED_R"], 0.15)
    add_via(10.5, 9.750, nets["LED_R"])
    add_track(10.5, 9.750, 10.5, 26.5, pcbnew.B_Cu, nets["LED_R"], 0.15)
    add_via(10.5, 26.5, nets["LED_R"])
    add_track(10.5, 26.5, 10.2, 26.9, pcbnew.F_Cu, nets["LED_R"], 0.15)
    add_track(10.2, 27.9, 12.0, 28.8, pcbnew.F_Cu, nets["LED_R"], 0.20)

    # LED_B: X = 11.2
    add_track(10.250, 9.062, 11.2, 9.062, pcbnew.F_Cu, nets["LED_B"], 0.15)
    add_via(11.2, 9.062, nets["LED_B"])
    add_track(11.2, 9.062, 11.2, 28.5, pcbnew.B_Cu, nets["LED_B"], 0.15)
    add_via(11.2, 28.5, nets["LED_B"])
    add_track(11.2, 28.5, 10.2, 28.9, pcbnew.F_Cu, nets["LED_B"], 0.15)
    ...
    add_via(12.2, 15.68, nets["VBUS_5V"])
    add_track(12.2, 15.68, 12.2, 24.5, pcbnew.B_Cu, nets["VBUS_5V"], 0.25)
    ...
    add_track(8.6, 24.7, 8.6, 26.8, pcbnew.B_Cu, nets["BATT_NEG"], 0.35)

    # BATT_POS
    add_track(4.1, 24.7, 4.1, 26.8, pcbnew.F_Cu, nets["BATT_POS"], 0.25)
    ...
    board.Save('/Users/racoon/Documents/CHEATING/Device1/hardware/test_channeled.kicad_pcb')
    print("Saved test_channeled.kicad_pcb")
