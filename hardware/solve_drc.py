#!/usr/bin/env python3
"""
Surgical PCB Layout Generator for Device 1 Rev 2.0.
Achieves 0 DRC violations and 0 unconnected items by construction.
"""
...
def build_board():
    ...
    # GND Vias for passives and IC pins (carefully located away from tracks and ports)
    gnd_vias = [
        ("C4",  "2", 0.7, 6.0),
        ("C14", "2", 2.5, 5.2),
        ("C13", "2", 2.5, 6.8),
    ...
    # TP_RF: Drop to B.Cu at (7.31, 5.2) and route on B.Cu to TP_RF (9.8, 7.2)
    tprf_net = nets["TP_RF"]
    ...
    # Oscillator: Y1
    # Y1.1 (0.9, 9.75) -> via at (0.9, 10.5) to B.Cu -> (3.2, 10.5) -> (3.2, 10.75) -> via at (3.2, 10.75) -> U1.26 (4.062, 10.75)
    ...
    add_track(3.2, 10.75, u1_26[0], u1_26[1], pcbnew.F_Cu, osc_in_net, 0.15)
    route_points([(0.9, 10.5), (3.2, 10.5), (3.2, 10.75)], pcbnew.B_Cu, osc_in_net, 0.15)

    # Y1.3 (2.3, 8.65) -> F.Cu straight to U1.27 (4.062, 11.25) via (3.2, 8.65) -> (3.2, 11.25)
    ...
    # VLXSMPS: U1.47 (9.75, 16.438) -> (9.75, 17.4) -> (9.2, 17.4) -> C12.1 (9.2, 17.92)
    vlx_net = nets["VLXSMPS"]
    u1_47 = get_pad_pos("U1", "47")
    c12_1 = get_pad_pos("C12", "1")
    route_points([u1_47, (9.75, 17.4), (9.2, 17.4), c12_1], pcbnew.F_Cu, vlx_net, 0.15)
    ...
    # CHG_STAT: U1.7 -> via at (12.0, 12.75) -> B.Cu down X=12.0 -> via at (9.8, 19.25) -> U2.1 (10.86, 19.25)
    ...
    add_via(9.8, 19.25, stat_net)
    add_track(9.8, 19.25, u2_1[0], u2_1[1], pcbnew.F_Cu, stat_net, 0.15)
    route_points([(12.0, 12.75), (12.0, 19.25), (9.8, 19.25)], pcbnew.B_Cu, stat_net, 0.15)

    # Audio I2S Lines:
    # MIC_WS: on F.Cu along X=0.8 from U1.32 to MK1.1
    mic_ws_net = nets["MIC_WS"]
    u1_32 = get_pad_pos("U1", "32") # (4.062, 13.75)
    mk1_1 = get_pad_pos("MK1", "1") # (6.600, 27.136)
    route_points([u1_32, (0.8, 13.75), (0.8, 27.136), mk1_1], pcbnew.F_Cu, mic_ws_net, 0.15)

    # MIC_SD: on B.Cu along X=0.4 from U1.33 to MK1.6
    ...
    add_via(7.5, 27.8, mic_sd_net)
    add_track(7.5, 27.8, mk1_6[0], mk1_6[1], pcbnew.F_Cu, mic_sd_net, 0.15)
    route_points([(3.0, 14.25), (0.4, 14.25), (0.4, 27.8), (7.5, 27.8)], pcbnew.B_Cu, mic_sd_net, 0.15)

    # MIC_SCK: on B.Cu along X=9.2 to MK1.4
    ...
    # UI LED Lines:
    # LED_R_DRV: drop via at (11.6, 10.25) to B.Cu -> X=10.25 on B.Cu -> R6.1 at (9.99, 27.5)
    ...
    add_track(9.99, 27.0, r6_1[0], r6_1[1], pcbnew.F_Cu, led_r_drv, 0.15)
    route_points([(11.6, 10.25), (10.25, 10.8), (10.25, 27.0), (9.99, 27.0)], pcbnew.B_Cu, led_r_drv, 0.15)
    ...
    # LED_B_DRV: drop via at (10.25, 8.5) to B.Cu -> X=11.6 on B.Cu -> R7.1 at (9.99, 29.2)
    ...
    add_track(9.99, 28.5, r7_1[0], r7_1[1], pcbnew.F_Cu, led_b_drv, 0.15)
    route_points([(10.25, 8.5), (11.6, 8.5), (11.6, 28.5), (9.99, 28.5)], pcbnew.B_Cu, led_b_drv, 0.15)
    ...
    # GATE_OD: U4.1 (1.863, 23.25) -> via at (1.863, 22.6) -> B.Cu to (8.637, 22.6) -> via to Q1.6 (8.637, 23.25)
    od_net = nets["GATE_OD"]
    u4_1 = get_pad_pos("U4", "1") # (1.863, 23.25)
    q1_6 = get_pad_pos("Q1", "6") # (8.637, 23.25)
    add_via(1.863, 22.6, od_net)
    add_track(u4_1[0], u4_1[1], 1.863, 22.6, pcbnew.F_Cu, od_net, 0.15)
    add_via(8.637, 22.6, od_net)
    add_track(8.637, 22.6, q1_6[0], q1_6[1], pcbnew.F_Cu, od_net, 0.15)
    add_track(1.863, 22.6, 8.637, 22.6, pcbnew.B_Cu, od_net, 0.15)

    # GATE_OC: U4.3 (1.863, 25.15) -> via at (1.863, 25.8) -> B.Cu to (8.637, 24.20) -> via to Q1.5 (8.637, 24.20)
    oc_net = nets["GATE_OC"]
    u4_3 = get_pad_pos("U4", "3") # (1.863, 25.15)
    q1_5 = get_pad_pos("Q1", "5") # (8.637, 24.20)
    add_via(1.863, 25.8, oc_net)
    add_track(u4_3[0], u4_3[1], 1.863, 25.8, pcbnew.F_Cu, oc_net, 0.15)
    add_via(8.637, 24.2, oc_net)
    add_track(8.637, 24.2, q1_5[0], q1_5[1], pcbnew.F_Cu, oc_net, 0.15)
    route_points([(1.863, 25.8), (7.5, 25.8), (7.5, 24.2), (8.637, 24.2)], pcbnew.B_Cu, oc_net, 0.15)

    # BATT_NEG: U4.6 (4.138, 23.25) -> via at (4.138, 21.8) -> B.Cu to TP_BATT_N (2.0, 26.8) and via at (8.637, 25.15)
    ...
    add_via(4.138, 21.8, batt_neg_net)
    add_track(u4_6[0], u4_6[1], 4.138, 21.8, pcbnew.F_Cu, batt_neg_net, 0.20)
    add_via(8.637, 25.15, batt_neg_net)
    route_points([tp_bn, (2.0, 21.8), (4.138, 21.8), (8.637, 21.8), (8.637, 25.15)], pcbnew.B_Cu, batt_neg_net, 0.20)
    ...
    # VBUS_5V (B.Cu backbone along X=13.5 -> X=12.3 around TP_3V3 -> U2.4, Q2.1, D1.2)
    ...
    route_points([tp_vbus, (13.5, 14.5)], pcbnew.B_Cu, vbus_net, 0.25)
    add_via(12.72, 14.5, vbus_net)
    route_points([c18_1, (12.72, 14.5), c10_1], pcbnew.F_Cu, vbus_net, 0.20)
    add_track(13.5, 14.5, 12.72, 14.5, pcbnew.B_Cu, vbus_net, 0.20)
    
    # Route on B.Cu around TP_3V3 down to U2.4 and Q2.1
    route_points([(13.5, 14.5), (13.5, 16.0), (12.3, 16.5), (12.3, 21.15)], pcbnew.B_Cu, vbus_net, 0.25)
    add_via(12.3, 21.15, vbus_net)
    add_track(12.3, 21.15, u2_4[0], u2_4[1], pcbnew.F_Cu, vbus_net, 0.20)
    route_points([(12.3, 21.15), (12.3, 22.4), (8.55, 22.4), d1_2], pcbnew.F_Cu, vbus_net, 0.20)
    add_track(11.062, 22.4, q2_1[0], q2_1[1], pcbnew.F_Cu, vbus_net, 0.20)

    # VBAT_PROT (F.Cu along Y=21.6)
    ...
    route_points([c17_1, (10.0, 17.8), (10.0, 21.6), (13.5, 21.6), (13.5, 24.2), q2_3], pcbnew.F_Cu, vbat_net, 0.20)
    add_track(10.0, 21.6, u2_3[0], u2_3[1], pcbnew.F_Cu, vbat_net, 0.20)

    # SYS_PWR: D1.1 (6.45, 21.2) -> F.Cu lane at Y=26.0 -> Q2.2 (11.062, 25.15)
    ...
    route_points([d1_1, (5.2, 21.20), (5.2, 26.0), (11.062, 26.0), q2_2], pcbnew.F_Cu, sys_net, 0.25)
    
    # Connect U5.3, U5.1, C9.1 to D1.1
    ...
    route_points([(2.5, 21.8), (2.5, 21.20), (5.2, 21.20)], pcbnew.F_Cu, sys_net, 0.20)
    ...
    add_track(u1_37[0], u1_37[1], 4.75, 17.4, pcbnew.F_Cu, p3v3_net, 0.20)
    add_track(4.75, 17.4, c20_1[0], c20_1[1], pcbnew.F_Cu, p3v3_net, 0.20)
    
    u1_41 = get_pad_pos("U1", "41") # (6.75, 16.438)
    add_track(u1_41[0], u1_41[1], 6.75, 17.4, pcbnew.F_Cu, p3v3_net, 0.20)
    add_track(6.75, 17.4, c21_1[0], c21_1[1], pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    # Left side 3V3 rail: drop via at (3.2, 9.0) for U1.25, and (3.0, 11.75) for U1.28
    u1_25 = get_pad_pos("U1", "25") # (4.062, 10.25)
    add_via(3.2, 9.0, p3v3_net)
    route_points([u1_25, (3.2, 10.25), (3.2, 9.0)], pcbnew.F_Cu, p3v3_net, 0.15)
    ...
    add_via(2.28, 15.2, p3v3_net)
    add_track(c1_1[0], c1_1[1], 2.28, 15.2, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_track(8.5, 16.85, 8.5, 17.4, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_via(1.32, 26.5, p3v3_net)
    add_track(1.32, 27.8, 1.32, 26.5, pcbnew.F_Cu, p3v3_net, 0.25)
