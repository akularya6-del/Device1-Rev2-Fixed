...
mfg_zip = os.path.join(root_dir, "manufacturing", "Device1_COMPLETE_HANDOFF_FIXED.zip")
root_zip = os.path.join(root_dir, "Device1_COMPLETE_HANDOFF_FIXED.zip")

# Ensure JLCPCB Gerbers are also copied to root for convenience
...
# Folders to include completely
include_dirs = ["hardware", "manufacturing", "firmware", "docs", "Device1.pretty"]
...
include_root_files = [
    ...
    "firmware_build.log",
    "REPAIR_CHANGELOG.md",
    "BLOCKER_EXECUTION_LOG.md",
    "RF_REFERENCE_COMPARISON.md",
    "VALIDATION_REPORT.md",
    "ENGINEERING_CORRECTIONS.md",
    "POST_BUILD_TEST_PLAN.md",
    "README.md",
    "RF_IMPEDANCE_FINAL.md",
    "STACKUP_FINAL.md",
]

exclude_exts = {".pyc", ".DS_Store", ".o", ".bak"}
exclude_dirs = {"__pycache__", ".git", "scratch_reports"}
...
with zipfile.ZipFile(mfg_zip, 'w', zipfile.ZIP_DEFLATED) as zf:
    ...
    for fname in include_root_files:
        ...
        if os.path.exists(fpath):
            ...
            # Also write under Device1/ prefix for standard archive extraction
    ...
    for d in include_dirs:
        ...
        for foldername, subfolders, filenames in os.walk(dirpath):
            ...
            for filename in filenames:
                if filename in ["Device1_COMPLETE_HANDOFF_FIXED.zip", "Device1_COMPLETE_HANDOFF.zip"]:
                    continue
...
print(f"Handoff ZIP successfully created at:")
