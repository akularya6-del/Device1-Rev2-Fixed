...
bom_entries = [
    ...
    ("ANT1", "0868AT43A0020E / 2450AT43F0100", "Johanson_2450AT43F0100", "0868AT43A0020E", "Johanson Technology", "C2897287", 1),
...
# JLCPCB Rotation offsets for standard footprints (KiCad vs JEDEC EIA-481)
# QFN/DFN: 0 deg offset
# SOT-23 / SOT-23-5 / SOT-23-6: 0 or 180 depending on pin 1
# 0402 passives: 0 deg
rot_offsets = {
    "U1": 0,
    "U2": 0,
...
with open(pos_path, 'r') as f:
    ...
    for row in reader:
        ...
        # Apply JLCPCB rotation calibration
...
print(f"Generated CPL file: {cpl_path} ({len(cpl_rows)} SMT components)")
