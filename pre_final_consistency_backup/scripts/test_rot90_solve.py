...
# L3 at (6.45, 7.90, rot=90)
# C22 at (6.45, 6.30, rot=0)  -> or (6.75, 6.30, rot=0)
# C23 at (5.25, 8.35, rot=90) -> or (5.80, 8.35, rot=0)
# Let's test L2 and L3 first with BOOT0!
...
\t\t(pad "2" smd roundrect (at 0.485 0 90) (size 0.59 0.64) (layers "F.Cu" "F.Mask" "F.Paste") (roundrect_rratio 0.25) (net "/RFI_N"))
\t)
"""
...
\t(segment (start 6.75 9.5625) (end 6.45 8.385) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000010"))
\t(segment (start 6.25 9.5625) (end 5.80 9.0) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000011"))
\t(segment (start 5.80 9.0) (end 5.80 7.415) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000012"))
\t(segment (start 5.80 7.415) (end 6.45 7.415) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000013"))
...
text = text[:idx] + fps + text[idx:]

zone_idx = text.find('\t(zone\n\t\t(net "/GND")')
text = text[:zone_idx] + tracks + text[zone_idx:]

with open("Device1/hardware/test_rot90_solve.kicad_pcb", "w") as f:
    f.write(text)
subprocess.run(["cp", "Device1/hardware/test_direct.kicad_pro", "Device1/hardware/test_rot90_solve.kicad_pro"])

res = subprocess.run(["kicad-cli", "pcb", "drc", "--refill-zones", "--severity-all", "Device1/hardware/test_rot90_solve.kicad_pcb"], capture_output=True, text=True)
with open("test_rot90_solve-drc.rpt") as f:
    rpt = f.read()

vios = re.findall(r"\[([a-z_]+)\]: ([^\n]+)", rpt)
print(f"Total violations: {len(vios)}")
for v in vios:
    print("  ", v)
