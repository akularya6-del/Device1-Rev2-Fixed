...
# Candidate 1: The original test_zero_drc with RFI_N fanout fixed and RFI_P routed via east
...
\t)
"""
    # Let's route RFI_P on B.Cu through two clean vias!
    # L3 Pad 2 is at (6.485, 8.38). Via 1 at (6.485, 7.80).
    # C22 Pad 2 is at (7.135, 6.15). Via 2 at (7.135, 5.50) or (7.70, 6.15).
    # Wait, let's see if there is any via collision at (6.485, 7.80) and (7.70, 6.15)
    tracks = """
...
"""
    # Evaluate this baseline WITHOUT the RFI_P connection between L3 and C22 to see what violations remain
    evaluate("candidate_base", fps, tracks)
