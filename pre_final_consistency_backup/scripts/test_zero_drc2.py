...
\t(segment (start 6.485 8.38) (end 6.485 7.75) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000012"))
\t(segment (start 6.485 7.75) (end 7.70 7.40) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000013"))
\t(segment (start 7.70 7.40) (end 7.70 6.40) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000014"))
\t(segment (start 7.70 6.40) (end 7.135 6.15) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000015"))

\t(segment (start 6.25 9.5625) (end 6.25 8.95) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000016"))
\t(segment (start 6.25 8.95) (end 5.515 8.38) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000017"))
\t(segment (start 5.515 8.38) (end 6.165 7.2) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000018"))

\t(segment (start 6.165 6.15) (end 6.29 5.2) (width 0.15) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000019"))

\t(segment (start 7.135 7.2) (end 7.5 7.2) (width 0.25) (layer "F.Cu") (net "/GND") (uuid "70020001-0000-4000-8000-000000000020"))

\t(segment (start 7.25 9.5625) (end 7.25 8.01) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000021"))
\t(via (at 7.25 8.01) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000022"))
\t(segment (start 7.25 8.01) (end 5.6 8.01) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000023"))
\t(segment (start 5.6 8.01) (end 5.6 4.0) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000024"))
...
\t(segment (start 7.25 4.0) (end 7.39 4.2) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000027"))
"""

evaluate("zero_drc2", fps, tracks)
