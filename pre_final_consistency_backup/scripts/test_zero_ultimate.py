...
# Let's test a via on net /GND right at C23 Pad 2 (7.135, 7.10)
# And let's fix the 2 clearances in RFI_P by routing RFI_P cleanly!
# L3 Pad 2 is at (6.485, 8.38).
# Pad 1 of C23 is at (6.165, 7.10).
# From (6.485, 8.38) -> (6.65, 7.75) -> (7.65, 7.75) -> (7.65, 6.15) -> (7.135, 6.15)
...
\t(segment (start 6.485 8.38) (end 6.65 7.75) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000012"))
\t(segment (start 6.65 7.75) (end 7.65 7.75) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000013"))
\t(segment (start 7.65 7.75) (end 7.65 6.15) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000014"))
\t(segment (start 7.65 6.15) (end 7.135 6.15) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000015"))
...
\t(segment (start 5.515 8.38) (end 6.165 7.10) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000018"))

\t(segment (start 6.165 6.15) (end 6.29 5.2) (width 0.15) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000019"))

\t(via (at 7.135 7.10) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/GND") (uuid "70020001-0000-4000-8000-000000000027"))

\t(segment (start 7.25 9.5625) (end 7.25 8.15) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000020"))
\t(via (at 7.25 8.15) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000021"))
\t(segment (start 7.25 8.15) (end 5.6 8.15) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000022"))
\t(segment (start 5.6 8.15) (end 5.6 4.0) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000023"))
...
evaluate("zero_ultimate", fps, tracks)
