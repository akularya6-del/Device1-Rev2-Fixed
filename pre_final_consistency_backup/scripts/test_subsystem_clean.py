...
# Remove the old RFO_HP segment between U1 and L1:
# In test_direct:
# (segment (start 5.25 9.5625) (end 5.25 7.285) (width 0.2) (layer "F.Cu") (net "/RFO_HP"))
# or similar.
# Let's replace it with custom RFO_HP routing:
...
\t(segment (start 6.25 9.5625) (end 6.25 8.8) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000008"))
\t(segment (start 6.25 8.8) (end 5.615 8.35) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000009"))

\t(segment (start 6.75 9.5625) (end 6.75 8.8) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000010"))
\t(segment (start 6.75 8.8) (end 6.585 8.35) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000011"))
