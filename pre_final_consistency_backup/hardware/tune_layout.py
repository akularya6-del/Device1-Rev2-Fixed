#!/usr/bin/env python3
"""
Tuned Board Generator for Device 1 Rev 2.0.
Calculates exact positions to guarantee zero DRC violations.
"""
...
def build_board():
    ...
    fp_placements = [
        ...
        ("C21", "Capacitor_SMD", "C_0402_1005Metric", 6.5, 18.4, 270),
    ...
    # GND Vias for passives and IC pins (carefully spaced >= 0.50 mm from any other feature)
    gnd_vias = [
        ("C4",  "2", 0.7, 6.0),
        ("C14", "2", 2.5, 5.2),
        ("C13", "2", 2.5, 6.8),
    ...
    # BOOT0: U1.19 -> R1.1 on F.Cu; via at (6.3, 5.5) to B.Cu -> TP_BOOT0 at (7.25, 4.0)
    boot_net = nets["BOOT0"]
    u1_19 = get_pad_pos("U1", "19") # (7.25, 9.562)
    r1_1  = get_pad_pos("R1", "1")  # Pad 1 of R1 at (7.25, 8.01)
    tp_b0 = get_pad_pos("TP_BOOT0", "1") # (7.25, 4.0)
    add_via(6.3, 5.5, boot_net)
    add_track(u1_19[0], u1_19[1], r1_1[0], r1_1[1], pcbnew.F_Cu, boot_net, 0.15)
    route_points([r1_1, (6.3, 8.01), (6.3, 5.5)], pcbnew.F_Cu, boot_net, 0.15)
    route_points([(6.3, 5.5), (6.3, 4.0), tp_b0], pcbnew.B_Cu, boot_net, 0.15)
    ...
    add_via(3.2, 10.75, osc_in_net)
    add_track(u1_26[0], u1_26[1], 3.2, 10.75, pcbnew.F_Cu, osc_in_net, 0.15)
    add_via(0.9, 10.5, osc_in_net)
    route_points([(3.2, 10.75), (3.2, 10.5), (0.9, 10.5)], pcbnew.B_Cu, osc_in_net, 0.15)
    add_track(0.9, 10.5, y1_1[0], y1_1[1], pcbnew.F_Cu, osc_in_net, 0.15)
    ...
    # VLXSMPS: Pin 47 at (9.75, 16.438) -> C12 Pad 1 at (9.2, 17.92)
    vlx_net = nets["VLXSMPS"]
    u1_47 = get_pad_pos("U1", "47")
    c12_1 = get_pad_pos("C12", "1")
    route_points([u1_47, (9.75, 17.2), (9.2, 17.2), c12_1], pcbnew.F_Cu, vlx_net, 0.20)
    ...
    # SWCLK: Pin 42 at (7.25, 16.438) -> TP_SWCLK at (7.25, 17.6)
    ...
    # Audio I2S Lines:
    # MIC_WS (B.Cu at X=0.5, arrives at Y=26.2)
    mic_ws_net = nets["MIC_WS"]
    u1_32 = get_pad_pos("U1", "32") # (4.062, 13.75)
    mk1_1 = get_pad_pos("MK1", "1") # (6.600, 27.136)
    add_via(3.0, 13.5, mic_ws_net)
    route_points([u1_32, (3.0, 13.75), (3.0, 13.5)], pcbnew.F_Cu, mic_ws_net, 0.15)
    add_via(6.6, 26.5, mic_ws_net)
    add_track(6.6, 26.5, mk1_1[0], mk1_1[1], pcbnew.F_Cu, mic_ws_net, 0.15)
    route_points([(3.0, 13.5), (0.5, 13.5), (0.5, 26.5), (6.6, 26.5)], pcbnew.B_Cu, mic_ws_net, 0.15)

    # MIC_SD (B.Cu at X=0.9, arrives at Y=26.9)
    mic_sd_net = nets["MIC_SD"]
    u1_33 = get_pad_pos("U1", "33") # (4.062, 14.25)
    mk1_6 = get_pad_pos("MK1", "6") # (7.500, 27.136)
    add_via(3.0, 15.0, mic_sd_net)
    route_points([u1_33, (3.0, 14.25), (3.0, 15.0)], pcbnew.F_Cu, mic_sd_net, 0.15)
    add_via(7.5, 26.5, mic_sd_net)
    add_track(7.5, 26.5, mk1_6[0], mk1_6[1], pcbnew.F_Cu, mic_sd_net, 0.15)
    route_points([(3.0, 15.0), (0.9, 15.0), (0.9, 26.5), (7.5, 26.5)], pcbnew.B_Cu, mic_sd_net, 0.15)

    # MIC_SCK (B.Cu down along X=8.0 to MK1.4)
    mic_sck_net = nets["MIC_SCK"]
    u1_17 = get_pad_pos("U1", "17") # (8.250, 9.562)
    mk1_4 = get_pad_pos("MK1", "4") # (8.400, 27.958)
    add_via(8.0, 8.8, mic_sck_net)
    add_track(u1_17[0], u1_17[1], 8.0, 8.8, pcbnew.F_Cu, mic_sck_net, 0.15)
    add_via(9.2, 27.958, mic_sck_net)
    add_track(9.2, 27.958, mk1_4[0], mk1_4[1], pcbnew.F_Cu, mic_sck_net, 0.15)
    route_points([(8.0, 8.8), (8.0, 27.2), (9.2, 27.2), (9.2, 27.958)], pcbnew.B_Cu, mic_sck_net, 0.15)
    ...
    route_points([u2_4, (13.5, 22.5), (11.062, 22.5), q2_1], pcbnew.F_Cu, vbus_net, 0.20)
    route_points([d1_2, (8.55, 19.5), (12.72, 19.5), (12.72, 16.5)], pcbnew.F_Cu, vbus_net, 0.20)
    ...
    route_points([c17_1, (10.863, 17.8), u2_3], pcbnew.F_Cu, vbat_net, 0.20)
    route_points([u2_3, (10.863, 21.8), (12.938, 21.8), q2_3], pcbnew.F_Cu, vbat_net, 0.20)
    ...
    route_points([d1_1, (5.0, 21.20), (5.0, 26.2), (11.062, 26.2), q2_2], pcbnew.F_Cu, sys_net, 0.25)
    route_points([d1_1, (5.0, 21.20), u5_3], pcbnew.F_Cu, sys_net, 0.25)
    route_points([u5_3, (1.863, 21.8), (1.0, 21.8), (1.0, 19.25), u5_1], pcbnew.F_Cu, sys_net, 0.20)
    route_points([u5_1, (1.0, 19.25), (1.0, 17.0), c9_1], pcbnew.F_Cu, sys_net, 0.20)

    # 7. 3V3 Power Plane Vias & Local F.Cu Routes
    u5_5  = get_pad_pos("U5", "5")  # (4.138, 19.25)
    c20_1 = get_pad_pos("C20", "1") # (5.6, 17.92)
    c21_1 = get_pad_pos("C21", "1") # (6.5, 17.92)
    route_points([u5_5, (4.138, 17.92), c20_1, c21_1], pcbnew.F_Cu, p3v3_net, 0.25)
    add_via(5.0, 17.5, p3v3_net)
    route_points([c20_1, (5.0, 17.92), (5.0, 17.5)], pcbnew.F_Cu, p3v3_net, 0.25)
    u1_37 = get_pad_pos("U1", "37") # (4.75, 16.438)
    add_track(u1_37[0], u1_37[1], 5.0, 17.5, pcbnew.F_Cu, p3v3_net, 0.20)
    u1_41 = get_pad_pos("U1", "41") # (6.75, 16.438)
    add_track(u1_41[0], u1_41[1], c21_1[0], c21_1[1], pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_via(3.0, 9.6, p3v3_net)
    add_track(u1_25[0], u1_25[1], 3.0, 9.6, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    add_via(2.28, 13.0, p3v3_net)
    add_track(c1_1[0], c1_1[1], 2.28, 13.0, pcbnew.F_Cu, p3v3_net, 0.20)
    ...
    route_points([mk1_5, (8.4, 26.5), (7.5, 26.5)], pcbnew.F_Cu, p3v3_net, 0.25)
    ...
    board.Save(out_pcb)
    print(f"Tuned board saved to {out_pcb}")
