...
# Let's test a complete layout setup
fps = """
...
\t(segment (start 6.485 8.38) (end 6.485 7.2) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000011"))

\t(segment (start 6.25 9.5625) (end 5.515 8.38) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000012"))

\t(segment (start 5.515 7.2) (end 5.25 6.315) (width 0.15) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000013"))
...
evaluate("clean_eval", fps, tracks)
