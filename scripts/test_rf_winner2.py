...
def apply_winner2():
    ...
    # Add 4 RF footprints using native footprint library naming (matching test_direct.kicad_pcb)
    rf_footprints = """
...
\t(segment (start 7.25 6.415) (end 6.8 5.8) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000016"))
\t(segment (start 6.8 5.8) (end 6.29 5.8) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000017"))
\t(segment (start 6.29 5.8) (end 6.29 5.2) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000018"))

\t(segment (start 7.25 9.5625) (end 7.25 8.35) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000019"))
\t(via (at 7.25 8.35) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000020"))
\t(segment (start 7.25 8.35) (end 8.3 8.35) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000021"))
\t(segment (start 8.3 8.35) (end 8.3 6.01) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000022"))
\t(via (at 8.3 6.01) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000023"))
\t(segment (start 8.3 6.01) (end 8.3 4.0) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000024"))
\t(segment (start 8.3 4.0) (end 7.25 4.0) (width 0.15) (layer "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000025"))

\t(via (at 8.8 4.99) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/GND") (uuid "70020001-0000-4000-8000-000000000026"))
\t(segment (start 8.3 4.99) (end 8.8 4.99) (width 0.2) (layer "F.Cu") (net "/GND") (uuid "70020001-0000-4000-8000-000000000027"))
"""
