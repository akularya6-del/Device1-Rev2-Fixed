...
# Let's test C23 rot 90 at (6.25, 7.30, 90) or (6.20, 7.30, 90)
def test_c23_rot90(c23_x=6.25, c23_y=7.30, c22_x=6.65, c22_y=6.15, l3_x=6.0, l3_y=8.38):
    fps = f"""
...
\t\t(fp_rect (start -0.93 -0.47) (end 0.93 0.47) (stroke (width 0.05) (type solid)) (fill no) (layer "F.CrtYd"))
\t\t(fp_rect (start -0.5 -0.25) (end 0.5 0.25) (stroke (width 0.1) (type solid)) (fill no) (layer "F.Fab"))
\t\t(pad "1" smd roundrect (at -0.485 0 90) (size 0.59 0.64) (layers "F.Cu" "F.Mask" "F.Paste") (roundrect_rratio 0.25) (net "/GND"))
...
"""
    # C23 rot 90:
    # pad 1 at (c23_x, c23_y - 0.485) -> GND
    # pad 2 at (c23_x, c23_y + 0.485) -> RFI_N
    c23_p1 = (c23_x, c23_y - 0.485)
    c23_p2 = (c23_x, c23_y + 0.485)
...
\t(segment (start 6.25 9.5625) (end 6.25 9.0) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000013"))
\t(segment (start 6.25 9.0) (end 5.515 8.38) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000014"))
\t(segment (start 5.515 8.38) (end {c23_p2[0]} {c23_p2[1]}) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000015"))

\t(segment (start 6.165 6.15) (end 6.29 5.2) (width 0.15) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000016"))

\t(segment (start {c23_p1[0]} {c23_p1[1]}) (end {c23_p1[0]} {c23_p1[1] - 0.3}) (width 0.25) (layer "F.Cu") (net "/GND") (uuid "70020001-0000-4000-8000-000000000017"))
...
"""
    return evaluate("c23_rot90", fps, tracks)
