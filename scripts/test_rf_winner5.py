...
def apply_winner5():
    ...
    text = re.sub(r'\t\(segment\s+\(start 4\.5 9\.75\)\s+\(end [0-9.]+\s+[0-9.]+\).*?\n\t\)', '', text, flags=re.DOTALL)

    # Keep via at (7.25 8.01) and keep B.Cu route (7.25 8.01) -> (5.6 8.01) -> (5.6 4.0) -> (7.25 4.0)
    # The existing segment is from (7.25 9.56) to (7.25 8.01) on F.Cu. We KEEP that segment! It connects U1 pin 19 to the via at (7.25 8.01)!
    # And at (7.25 4.0), drop a via or connect to TP_BOOT0 and R1 pad 1
...
\t(segment (start 6.25 9.5625) (end 6.25 8.7) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000006"))
\t(segment (start 6.25 8.7) (end 5.515 8.25) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000007"))
\t(segment (start 5.515 8.25) (end 6.15 7.035) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000008"))

\t(segment (start 6.75 9.5625) (end 6.75 8.7) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000009"))
\t(segment (start 6.75 8.7) (end 6.485 8.25) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000010"))
\t(segment (start 6.485 8.25) (end 7.05 7.035) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000011"))

\t(segment (start 7.05 6.065) (end 6.6 5.6) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000012"))
\t(segment (start 6.6 5.6) (end 6.29 5.6) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000013"))
\t(segment (start 6.29 5.6) (end 6.29 5.2) (width 0.2) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000014"))

\t(via (at 7.25 4.0) (size 0.45) (drill 0.25) (layers "F.Cu" "B.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000015"))
\t(segment (start 7.415 4.2) (end 7.25 4.2) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000016"))
\t(segment (start 7.25 4.2) (end 7.25 4.0) (width 0.15) (layer "F.Cu") (net "/BOOT0") (uuid "70020001-0000-4000-8000-000000000017"))
"""
