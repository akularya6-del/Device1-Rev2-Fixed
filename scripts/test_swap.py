...
# Candidate: C22 at (6.65, 7.20), C23 at (6.65, 6.15)
fps = """
...
# Let's test routing for this layout
tracks = """
...
\t(segment (start 6.485 8.38) (end 7.135 7.20) (width 0.15) (layer "F.Cu") (net "/RFI_P") (uuid "70020001-0000-4000-8000-000000000012"))

\t(segment (start 6.25 9.5625) (end 6.25 9.05) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000013"))
\t(segment (start 6.25 9.05) (end 5.515 8.38) (width 0.15) (layer "F.Cu") (net "/RFI_N") (uuid "70020001-0000-4000-8000-000000000014"))

\t(segment (start 6.165 7.20) (end 6.29 5.2) (width 0.15) (layer "F.Cu") (net "/RF_50OHM") (uuid "70020001-0000-4000-8000-000000000015"))
...
evaluate("swap_c22_c23", fps, tracks)
